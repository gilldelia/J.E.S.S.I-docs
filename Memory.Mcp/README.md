...
See the [field guide and limitations](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/docs/contextual-tensions.md).
...
The optional [Ame dashboard](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/docs/runbooks/ame-dashboard.md) adds server-rendered
...
The optional [A2b device-authority contract](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/docs/device-usage.md) adds
...
and scope. It returns only the current opaque binding, never the profile or
memories. These are technical permissions, not personality, and are not MCP
tools. DeviceHub has no project reference to this host or the Âme library.
...
contract and separate LLM evaluation](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/Motivation/conversation.md). A client
...
[source contract, MCP example and limits](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/Motivation/learning.md).
...
See the [field-by-field example and limits](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/docs/memory-experience.md).
Sourced [relational episodes](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/docs/relational-memory.md) use
...
or background loops change. `ame_begin`/`ame_context` and HTTP session contexts
also include `affectContext`, revalidated through the same read-only projection.
An upstream outage fails the context instead of returning a stale or fabricated
...
[algorithm, fields, examples and limits](https://github.com/gilldelia/J.E.S.S.I/blob/6491aff36f05aad47a385ae9cd6af17cf21dcbd9/docs/affective-state.md).
