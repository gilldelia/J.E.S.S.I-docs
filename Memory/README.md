...
Le modèle cognitif canonique est défini dans [INVARIANTS.md](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/Memory/INVARIANTS.md). Memory n'est pas un simple RAG : il organise le cycle de vie d'une information entre contexte actif, souvenir explicite et connaissance internalisée.
...
La documentation OpenAPI est exposée par Swagger. La [publication publique](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/readme-publication.md)
