...
Le modèle cognitif canonique est défini dans [INVARIANTS.md](https://github.com/gilldelia/J.E.S.S.I/blob/f87857be78f03f4107338e0d3456187a17564c38/Memory/INVARIANTS.md). Memory n'est pas un simple RAG : il organise le cycle de vie d'une information entre contexte actif, souvenir explicite et connaissance internalisée.
...
La documentation OpenAPI est exposée par Swagger. La [publication publique](https://github.com/gilldelia/J.E.S.S.I/blob/f87857be78f03f4107338e0d3456187a17564c38/docs/readme-publication.md)
