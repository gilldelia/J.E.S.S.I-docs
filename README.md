...
- **Un tableau de bord des Âmes.** Une interface française permet de consulter,
  ...
  la connexion JESSI existante. Elle est [désactivée par défaut et s'active explicitement](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/runbooks/ame-dashboard.md) ;
  elle ne copie aucun goût du propriétaire. Une activation distincte permet
  de [gérer les accords appareils par Âme](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/runbooks/ame-device-dashboard.md) :
...
- **Une perception qui tient compte des acquis.** En mode adaptatif avec le
  ...
  Voir les [règles et limites de cette comparaison](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/contextual-perception.md).
...
- **Des tendances adaptées à l'échange.** Le client peut signaler, par des
  ...
  Voir le [contrat et ses limites](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/contextual-tensions.md) ; la qualité de
...
- **Un état affectif logiciel révisable.** Des appels explicites peuvent retenir
  ...
  pas les réponses du modèle. Voir le [contrat et ses limites](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/affective-state.md).
...
Les [invariants mémoire](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/Memory/INVARIANTS.md) décrivent les règles du cycle.
...
| [DeviceHub](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/DeviceHub/README.md) | Service HTTP indépendant : catalogue fictif, appairage et droits explicites par application/Âme, isolés par propriétaire OAuth et révocables. Vérification auprès de l'autorité Âme, sans accès matériel. |
| [Ame.Console](Ame.Console/README.md) | Ancien client de compatibilité, pas le point d'entrée du parcours OAuth par Âme. |

Pour contribuer, commencer par la [carte du projet](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/project-map.md) :
elle indique les points d'entrée, contrats, invariants et tests à lire selon
l'évolution, sans parcourir tout le dépôt. L'[architecture cible](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/architecture/cognitive-target.md)
...
Le [guide local](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/runbooks/local-memory-real.md) détaille les modèles,
...
par Âme, suivre le [guide OAuth auto-hébergé](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/runbooks/home-oauth.md).
...
[démarrage de la passerelle HTTPS](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/runbooks/home-oauth.md#démarrer-https).
...
- consulter les [contrats API/MCP](Memory.Mcp/README.md) et le
  [protocole d'essai sur une semaine](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/Motivation/maturation.md#essai-utilisateur-sur-une-semaine).
...
Le client peut joindre des [émotions attribuées et circonstances d'apprentissage](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/memory-experience.md)
...
Les [épisodes relationnels sourcés](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/relational-memory.md) permettent aussi
...
Voir la [CI locale](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/local-ci.md) et la [certification M12](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/qa/m12-e2e.md).

L'[orchestrateur de livraison local](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/release-orchestrator.md) automatise
...
[diagnostic à la demande](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/local-ci.md#diagnostic-à-la-demande-sans-nouvelle-uac)
...
2. Lire les [règles du dépôt](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/AGENTS.md), puis le parcours de la carte concerné.
...
4. Suivre la [revue indépendante et les promotions](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/development-workflow.md) :
...
La seule exception GitHub Actions autorisée est la [publication des README](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/docs/readme-publication.md)
...
Voir le fichier [LICENSE](https://github.com/gilldelia/J.E.S.S.I/blob/0b8ff62a6acb93d21ed9483ad99eaf495e0cec68/LICENSE) du dépôt source.
