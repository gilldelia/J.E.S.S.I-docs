...
- **Une perception qui tient compte des acquis.** En mode adaptatif avec le
  ...
  Voir les [règles et limites de cette comparaison](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/contextual-perception.md).
...
- **Un état affectif logiciel révisable.** Des appels explicites peuvent retenir
  ...
  du client automatiquement. Voir le [contrat et ses limites](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/affective-state.md).
...
Les [invariants mémoire](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/Memory/INVARIANTS.md) décrivent les règles du cycle.
...
Pour contribuer, commencer par la [carte du projet](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/project-map.md) :
elle indique les points d'entrée, contrats, invariants et tests à lire selon
l'évolution, sans parcourir tout le dépôt. L'[architecture cible](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/architecture/cognitive-target.md)
...
Le [guide local](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/runbooks/local-memory-real.md) détaille les modèles,
...
par Âme, suivre le [guide OAuth auto-hébergé](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/runbooks/home-oauth.md).
...
[démarrage de la passerelle HTTPS](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/runbooks/home-oauth.md#démarrer-https).
...
- consulter les [contrats API/MCP](Memory.Mcp/README.md) et le
  [protocole d'essai sur une semaine](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/Motivation/maturation.md#essai-utilisateur-sur-une-semaine).
...
Le client peut joindre des [émotions attribuées et circonstances d'apprentissage](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/memory-experience.md)
...
Les [épisodes relationnels sourcés](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/relational-memory.md) permettent aussi
...
Voir la [CI locale](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/local-ci.md) et la [certification M12](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/qa/m12-e2e.md).

L'[orchestrateur de livraison local](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/release-orchestrator.md) automatise
...
2. Lire les [règles du dépôt](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/AGENTS.md), puis le parcours de la carte concerné.
...
4. Suivre la [revue indépendante et les promotions](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/development-workflow.md) :
...
La seule exception GitHub Actions autorisée est la [publication des README](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/docs/readme-publication.md)
...
Voir le fichier [LICENSE](https://github.com/gilldelia/J.E.S.S.I/blob/954486ecd829551d59d4a61f84f276f08c6993e9/LICENSE) du dépôt source.
